      ...
      <div class="col-sm-12">
        <footer>
          <ul class="footer-link">
            ...
            <li><a href="http://featherwebs.com">Terms of Service</a></li>
            <li><a href="http://featherwebs.com">Privacy Policy</a></li>
            <li><a href="http://featherwebs.com">Send Feedback</a></li>
          </ul>
        </footer>
      </div>
    </div>
