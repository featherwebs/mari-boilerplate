          ...
          <div class="blog__left--wrapper">
            <div class="blog__lt--wrapper">
              <div class="blog__slider--main bs--wrapper sliderside--show">
                @foreach(fw_posts_by_category('series') as $category)
                  <div class="blog__slider--content bs--content">
                    <a href="{!! route('series', $category)!!}">
                      <figure>
            ...
            <div class="blog__lb--wrapper">
              @if($blogs=fw_posts_by_category('story', false, true)->whereHas('custom', function($q)use($post) {
                $q->where('slug', 'series')
                  ->where('value', $post->id);
              })->paginate(10))
