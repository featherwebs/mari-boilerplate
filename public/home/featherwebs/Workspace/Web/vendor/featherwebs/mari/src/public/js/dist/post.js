...
var update = __webpack_require__(35)("484ccbb6", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d7841e9a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ImageSelector.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d7841e9a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ImageSelector.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        if (this.id) this.fileid = this.id;else this.fileid = this.getRandom();
    },
    ...
    methods: {
        ...
        closeModal: function closeModal(cancel) {
            if (cancel) {
                this.mode = '';
            } else {
                if (this.imageSelected) this.$emit('change', this.imageSelected.thumbnail);else if (this.base64) this.$emit('change', this.base64);
            }
        ...
        openModal: function openModal() {
            ...
            axios.post('/api/media').then(function (_ref) {
                var data = _ref.data;
        ...
        doNotCloseModal: function doNotCloseModal(e) {
            e.stopPropagation();
        },
        toggleSelectedImage: function toggleSelectedImage(image) {
            if (this.imageSelected == image) this.imageSelected = null;else this.imageSelected = image;
        },
...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      [
        _c("i", { staticClass: "material-icons" }, [_vm._v("perm_media")]),
        _vm._v("\n\t\tAdd Image\n\t")
      ]
    ),
    _vm._v(" "),
    _vm.mode == "select"
      ? _c("div", [
          _c("input", {
            ...
            domProps: { value: _vm.imageSelected ? _vm.imageSelected.id : "" }
          })
        ])
      : _vm._e(),
    _vm._v(" "),
      ...
      ? _c("div", [
          _c("input", {
            ...
            attrs: {
              type: "file",
              id: "image-selector",
              name: _vm.fileName ? _vm.fileName : _vm.name,
        ...
        _c(
          ...
          [
                        ...
                        ? _c("div", [
                            _c("div", { staticClass: "row" }, [
                              _c(
                                ...
                                _vm._l(
                                  _vm.lodash.chunk(_vm.images, 6),
                                  function(chunk) {
                                    return _c(
                                      "div",
                                      { staticClass: "row" },
                                      _vm._l(chunk, function(image) {
                                        return _c(
                                          "div",
                                          {
                                            staticClass:
                                              "col-sm-2 img-previews",
                                            on: {
                                              click: function($event) {
                                                _vm.toggleSelectedImage(image)
                                              }
                                            }
                                          },
                                          [
            ...
            _c("div", { staticClass: "modal-footer" }, [
              _vm.imageSelected || _vm.base64
                ? _c(
                    "button",
                    {
                      staticClass: "mdl-button mdl-button--colored pull-right",
                      attrs: { type: "button" },
                      on: {
                        click: function($event) {
              ...
              _c(
                ...
                {
                  staticClass:
                    "mdl-button mdl-button--colored pull-right mdl-color-text--red",
                  attrs: { type: "button" },
                  on: {
                    click: function($event) {
                      _vm.closeModal(true)
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c("h4", { staticClass: "modal-title" }, [_vm._v("Insert Images")])
    ])
  }
]
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(35)("ccef1998", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Ckeditor_vue__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ImageSelector_vue__ = __webpack_require__(38);
...
var app = new Vue({
    ...
    data: {
        ...
        editor: {
            mini: {
                toolbarGroups: [{ "name": "basicstyles", "groups": ["basicstyles"] }, { "name": "links", "groups": ["links"] }, { "name": "paragraph", "groups": ["list", "blocks"] }, { "name": "document", "groups": ["mode"] }, { "name": "insert", "groups": ["insert"] }, { "name": "styles", "groups": ["styles"] }, { "name": "about", "groups": ["about"] }],
                allowedContent: true,
    ...
    mounted: function mounted() {
        ...
        if (this.post_type) {
            this.post_type.custom.filter(function (c) {
                return c.type != 'image';
            }).map(function (field) {
                if (!_this.post.custom.filter(function (c) {
                    return c.slug == field.slug;
                }).length) {
                    var obj = Object.assign({}, field);
                    obj.value = defaults.custom[field.slug];
                    _this.post.custom.push(obj);
                }
            });
